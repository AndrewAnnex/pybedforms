FILENM 	=	'fig32b'	;	%	
FIGCAP 	=	'Linguoid bedforms in phase' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SNMGF1 	=	13.0 	;	%	(14) Amplitude (measured in plan-form) of first set of sinuosities
...
SNMGS1 	=	13.0 	;	%	(37) Amplitude (measured in plan-form) of first set of sinuosities
SNFZS1 	=	0.0 	;	%	(38) Phase of first set of sinuosities
SNVLS1 	=	0.0 	;	%	(39) Migration speed (along-crest) of first set of sinuosities 
SNSPS2 	=	25.0	;	%	(40) Wavelength (along-crest) of second set of plan-form sinuosities
SNMGS2 	=	3.0 	;	%	(41) Amplitude (measured in plan-form) of second set of sinuosities
SNFZS2 	=	90.0 	;	%	(42) Phase of second set of sinuosities
