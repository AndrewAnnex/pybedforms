FILENM	=	'fig78';	% (1) File Number					 
FIGCAP	=	'Dunes reverse, and angle of climb is +90 degrees';	%     (2)  Caption (CHARACTER VARIABLE)					
SPCNGF	=	50.0;	    %   (3)  WAVELENGTH OF BEDFORMS IN FIRST SET					
PHASEF	=	0.0	;	%   (4)  Bedform phase (controls placement within block diagram)					
SMTRYF	=	0.0	;	 %   (5)  Mean asymmetry					
SMCHGF	=	1.0	;	  %   (6)  Amplitude of asymmetry cycle					
SMPRDF	=	10.0;	 %   (7)  Period of asymmetry cycle					
SMFAZF	=	90.0;	 %   (8)  Phase of asymmetry cycle					
HTRTOF	=	0.5	;	    %     (9)  Mean steepness					
HTCHGF	=	0.0	;	 %   (10) Amplitude of steepness cycle					
HTPRDF	=	1.0	;	 %   (11) Period of steepness cycle					
HTFAZF	=	0.0	;	 %   (12) Phase of steepness cycle					
SNSPF1	=	40.0;	%   (13) Wavelength (along-crest) of first set of plan-form sinuosities					
SNMGF1	=	4.0	;	 %   (14) Amplitude (measured in plan-form) of first set of sinuosities					
SNFZF1	=	90.0;	%   (15) Phase of first set of sinuosities					
SNVLF1	=	-1.0;	%   (16) Migration speed (along-crest) of first set of sinuosities 					
...
VELOCF	=	0.0	;	%   (22) Mean migration speed of bedform
VLCHGF	=	0.5	;	 %   (23) Amplitude of speed cycle
VLPRDF	=	12.0;	%   (24) Period of speed cycle
VLFAZF	=	90.0;	%   (25) Phase of speed cycle
SPCNGS	=	11.0;	%   (26) WAVELENGTH OF BEDFORMS IN SECOND SET
...
HTRTOS	=	0.5	;	 %    (32) Mean steepness
HTCHGS	=	0.0	;	 %   (33) Amplitude of steepness cycle
HTPRDS	=	1.0	;	%   (34) Period of steepness cycle
HTFAZS	=	0.0	;	%   (35) Phase of steepness cycle
SNSPS1	=	30.0;	%   (36) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGS1	=	3.0	;	 %   (37) Amplitude (measured in plan-form) of first set of sinuosities
...
VELOCS	=	2.0	;	%   (45) Mean migration speed of bedform
...
TYPE	=	4.0	;	  %(72) Type of superpositioning (INTEGER)
CHOICE	=	0.0	;	%   (73) Rotation option (INTEGER
ELVMIN	=	-0.2;	    %   (74) Elevation of interdune flats 
DEPRAT	=	0.2	;	    %   (75) Rate of deposition
...
NBEDSH	=	7000;	      %   (79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD	=	6	;	%   (80) Interval between drawing of crossbeds (INTEGER)
FRMNUM	=	1.0	;	%   (81) Time from t=0 to end of depositional episode (INTEGER)
...
IGRDSP	=	1.0	;	   %(85) Precision? (low number) or speed? (high number) (1, 2, 4, 5, or 10)
