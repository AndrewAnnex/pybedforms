FILENM 	=	'fig21'	;	%	
FIGCAP 	=	'Oscillating with net migration' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	100.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
...
SMPRDF 	=	24.0	;	%	(7)  Period of asymmetry cycle
...
VELOCF 	=	.65	;	%	(22) Mean migration speed of bedform
VLCHGF 	=	1.3	;	%	(23) Amplitude of speed cycle
VLPRDF 	=	24.0	;	%	(24) Period of speed cycle
VLFAZF 	=	90.0	;	%	(25) Phase of speed cycle
SPCNGS 	=	0.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
...
DEPRAT 	=	.2	;	%	(75) Rate of deposition
...
NBEDSH 	=	8000	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD 	=	10	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	6	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
