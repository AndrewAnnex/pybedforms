FILENM 	=	'fig56'	;	%	
FIGCAP 	=	'Non-migrating bedforms with superimposed out-of-phase bedforms'	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	100.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
PHASEF 	=	60.0	;	%	(4)  Bedform phase (controls placement within block diagram)
