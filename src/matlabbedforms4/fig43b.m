FILENM 	=	'fig43b'	;	%	
FIGCAP 	=	'Bedforms with migrating out-of-phase sinuosities' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SNMGF2 	=	4.5 	;	%	(18) Amplitude (measured in plan-form) of second set of sinuosities
...
VELOCF 	=	.4	;	%	(22) Mean migration speed of bedform
...
SNMGS2 	=	4.5 	;	%	(41) Amplitude (measured in plan-form) of second set of sinuosities
...
VELOCS 	=	.4	;	%	(45) Mean migration speed of bedform
...
DEPRAT 	=	.05	;	%	(75) Rate of deposition
