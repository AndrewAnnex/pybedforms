FILENM 	=	'fig65'	;	%	
FIGCAP 	=	'Two-D bedforms with superimposed sinuous out-of-phase bedforms' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SNSPF2 	=	1.0	;	%	(17) Wavelength (along-crest) of second set of plan-form sinuosities
...
SNSPS1 	=	25.0	;	%	(36) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGS1 	=	3.3 	;	%	(37) Amplitude (measured in plan-form) of first set of sinuosities
SNFZS1 	=	180.0 	;	%	(38) Phase of first set of sinuosities
SNVLS1 	=	0.0 	;	%	(39) Migration speed (along-crest) of first set of sinuosities 
SNSPS2 	=	12.5	;	%	(40) Wavelength (along-crest) of second set of plan-form sinuosities
SNMGS2 	=	1.0 	;	%	(41) Amplitude (measured in plan-form) of second set of sinuosities
...
SNSPT1 	=	25.0	;	%	(59) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGT1 	=	3.3 	;	%	(60) Amplitude (measured in plan-form) of first set of sinuosities
SNFZT1 	=	0.0 	;	%	(61) Phase of first set of sinuosities
SNVLT1 	=	0.0 	;	%	(62) Migration speed (along-crest) of first set of sinuosities 
SNSPT2 	=	12.5	;	%	(63) Wavelength (along-crest) of second set of plan-form sinuosities
SNMGT2 	=	1.0 	;	%	(64) Amplitude (measured in plan-form) of second set of sinuosities
SNFZT2 	=	270.0 	;	%	(65) Phase of second set of sinuosities
SNVLT2 	=	0.0 	;	%	(66) Migration speed (along-crest) of second set of sinuosities 
TRENDT 	=	90.0	;	%	(67) Migration direction of bedform
VELOCT 	=	1.5	;	%	(68) Mean migration speed of bedform
VLCHGT 	=	0.0	;	%	(69) Amplitude of speed cycle
VLPRDT 	=	1.0	;	%	(70) Period of speed cycle
VLFAZT 	=	0.0	;	%	(71) Phase of speed cycle
TYPE 	=	5	;	%	(72) Type of superpositioning (INTEGER)
...
NBEDSH 	=	6000	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
