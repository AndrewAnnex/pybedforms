FILENM 	=	'fig15' ;	%	
FIGCAP 	=	'Small and slow height fluctuations' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
HTRTOF 	=	.7 	;	%	  (9)  Mean steepness
HTCHGF 	=	.12	;	%	(10) Amplitude of steepness cycle
HTPRDF 	=	64.0	;	%	(11) Period of steepness cycle
...
FRMNUM 	=	-31	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
