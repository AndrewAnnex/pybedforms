FILENM 	=	'fig46l'	;	%	
FIGCAP 	=	'Two sets of bedforms height ratio is 0.9 speed ratio is 3.0' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
VELOCS 	=	1.65	;	%	(45) Mean migration speed of bedform
...
DEPRAT 	=	.044	;	%	(75) Rate of deposition
...
NBEDSH 	=	2720	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD 	=	4	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	36	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
