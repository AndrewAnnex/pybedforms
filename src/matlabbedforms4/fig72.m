FILENM 	=	'fig72'	;	%	
FIGCAP 	=	'Bedforms with obliquely downslope-migrating superimposed bedforms' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
TRENDS 	=	45.0	;	%	(44) Migration direction of bedform
...
TRENDT 	=	45.0	;	%	(67) Migration direction of bedform
...
NBEDSH 	=	2000	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
