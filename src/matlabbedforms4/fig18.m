FILENM 	=	'fig18'	;	%	
FIGCAP 	=	'Reversing symmetry without migrating'	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SMPRDF 	=	32.0	;	%	(7)  Period of asymmetry cycle
...
FRMNUM 	=	-8	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
