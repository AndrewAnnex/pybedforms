FILENM 	=	'fig16'	;	%	
FIGCAP 	=	'Small but rapid height fluctuations' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
HTRTOF 	=	0.7 	;	%	  (9)  Mean steepness
HTCHGF 	=	0.12	;	%	(10) Amplitude of steepness cycle
HTPRDF 	=	14.0	;	%	(11) Period of steepness cycle
...
TYPE 	=	2.0	;	%	(72) Type of superpositioning (INTEGER)
