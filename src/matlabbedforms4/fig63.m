FILENM 	=	'fig63'	;	%	
FIGCAP 	=	'Reversing bedforms with spurs angle of climb nearly vertical' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	23.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
PHASEF 	=	0.0	;	%	(4)  Bedform phase (controls placement within block diagram)
SMTRYF 	=	0.0	;	%	(5)  Mean asymmetry
SMCHGF 	=	.7	;	%	(6)  Amplitude of asymmetry cycle
SMPRDF 	=	150.0	;	%	(7)  Period of asymmetry cycle
...
VLCHGF 	=	.7	;	%	(23) Amplitude of speed cycle
VLPRDF 	=	150.0	;	%	(24) Period of speed cycle
VLFAZF 	=	180.0	;	%	(25) Phase of speed cycle
SPCNGS 	=	18.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
...
DEPRAT 	=	.25	;	%	(75) Rate of deposition
DEPCHG 	=	.21	;	%	(76) Amplitude of cycle in rate of deposition
DEPPRD 	=	75.0	;	%	(77) Period of cycle in rate of deposition
DEPFAZ 	=	0.0	;	%	(78) Phase of cycle in rate of deposition
NBEDSH 	=	7500	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
