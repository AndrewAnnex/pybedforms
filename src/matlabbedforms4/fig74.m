FILENM 	=	'fig74'	;	%	
FIGCAP 	=	'Bedforms with 2 sets of alternately active superimposed bedforms' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	80.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
...
TRENDF 	=	45.0	;	%	(21) Migration direction of bedform
...
SPCNGS 	=	23.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
...
HTCHGS 	=	1.0	;	%	(33) Amplitude of steepness cycle
HTPRDS 	=	20.0	;	%	(34) Period of steepness cycle
HTFAZS 	=	-90.0	;	%	(35) Phase of steepness cycle
...
TRENDS 	=	-90.0	;	%	(44) Migration direction of bedform
...
SPCNGT 	=	17.0	;	%	(49) WAVELENGTH OF BEDFORMS IN THIRD SET
...
HTRTOT 	=	1.0	;	%	(55) Mean steepness
HTCHGT 	=	1.0	;	%	(56) Amplitude of steepness cycle
HTPRDT 	=	20.0	;	%	(57) Period of steepness cycle
HTFAZT 	=	90.0	;	%	(58) Phase of steepness cycle
...
DEPRAT 	=	0.024	;	%	(75) Rate of deposition
...
NBEDSH 	=	1500	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD 	=	4	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	60.0	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
