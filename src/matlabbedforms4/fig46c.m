FILENM 	=	'fig46c'	;	%	
FIGCAP 	=	'Two sets of bedforms--migration directions diverge by 135 degrees' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
TRENDS 	=	315.0	;	%	(44) Migration direction of bedform
...
FRMNUM 	=	20	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
