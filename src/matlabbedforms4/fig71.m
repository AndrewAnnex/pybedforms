FILENM 	=	'fig71'	;	%	
FIGCAP 	=	'Bedforms with spurs that reverse asymmetry oscillate and migrate' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SPCNGS 	=	60.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
PHASES 	=	0.0	;	%	(27) Bedform phase (controls placement within block diagram)
SMTRYS 	=	0.0	;	%	(28) Mean asymmetry 
SMCHGS 	=	1.0	;	%	(29) Amplitude of asymmetry cycle
SMPRDS 	=	18	;	%	(30) Period of asymmetry cycle
SMFAZS 	=	180.0	;	%	(31) Phase of asymmetry cycle
...
VELOCS 	=	1.8	;	%	(45) Mean migration speed of bedform
VLCHGS 	=	2.8	;	%	(46) Amplitude of speed cycle
VLPRDS 	=	18.0	;	%	(47) Period of speed cycle
VLFAZS 	=	90.0	;	%	(48) Phase of speed cycle
...
NBEDSH 	=	3500	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD 	=	4	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	43	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
