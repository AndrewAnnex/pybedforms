% To effectively view Figure 67, change the 'Linewidth' values in NewDunes
% to 0.2 on lines 67, 77, 78, 79, and 80.

FILENM 	=	'fig67'	;	%	
FIGCAP 	=	'Sinuous bedforms reversing symmetry with superimposed bedforms' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	10.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
...
SNMGF1 	=	6.0 	;	%	(14) Amplitude (measured in plan-form) of first set of sinuosities
...
SPCNGS 	=	19.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
PHASES 	=	180.0	;	%	(27) Bedform phase (controls placement within block diagram)
SMTRYS 	=	0.0	;	%	(28) Mean asymmetry 
SMCHGS 	=	.5	;	%	(29) Amplitude of asymmetry cycle
SMPRDS 	=	24.0	;	%	(30) Period of asymmetry cycle
...
VLCHGS 	=	2.0	;	%	(46) Amplitude of speed cycle
VLPRDS 	=	24.0	;	%	(47) Period of speed cycle
...
INTXBD 	=	50	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	12	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
