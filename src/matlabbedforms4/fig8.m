FILENM 	=	'fig08'	;	%	
FIGCAP 	=	'Stoss-erosional lee-depositional net-zero climb'	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
DEPRAT 	=	0.0	;	%	(75) Rate of deposition
...
NBEDSH 	=	5000	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
