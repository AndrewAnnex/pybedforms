FILENM	=	'fig59'	;	% (1) File Number					 
FIGCAP	=	'Bedforms with spurs that reverse asymmetry while oscillating'  	;	%     (2)  Caption (CHARACTER VARIABLE)					
...
VELOCF	=	0.5	;	%   (22) Mean migration speed of bedform
VLCHGF	=	0.0	;	 %   (23) Amplitude of speed cycle
VLPRDF	=	1.0	;	%   (24) Period of speed cycle
VLFAZF	=	0.0	;	%   (25) Phase of speed cycle
SPCNGS	=	50.0	;	%   (26) WAVELENGTH OF BEDFORMS IN SECOND SET
PHASES	=	60.0	;	%   (27) Bedform phase (controls placement within block diagram)
SMTRYS	=	0.0	;	 %   (28) Mean asymmetry 
SMCHGS	=	0.5	;	  %   (29) Amplitude of asymmetry cycle
SMPRDS	=	9.0	;	 %   (30) Period of asymmetry cycle
...
VLCHGS	=	2.5	;	 %   (46) Amplitude of speed cycle
VLPRDS	=	9.0	;	%   (47) Period of speed cycle
...
DEPRAT	=	0.1	;	    %   (75) Rate of deposition
...
FRMNUM	=	0.0	;	   %   (81) Time from t=0 to end of depositional episode (INTEGER)
