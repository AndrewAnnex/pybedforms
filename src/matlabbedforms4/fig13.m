FILENM 	=	'fig13'	;	%	
FIGCAP 	=	'Angle of climb fluctuating but always positive' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	25.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
...
VELOCF 	=	2.0	;	%	(22) Mean migration speed of bedform
...
DEPCHG 	=	.19	;	%	(76) Amplitude of cycle in rate of deposition
DEPPRD 	=	45.0	;	%	(77) Period of cycle in rate of deposition
