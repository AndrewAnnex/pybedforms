FILENM 	=	'fig42b'	;	%	
FIGCAP 	=	'Bedforms with migrating in-phase sinuosities'	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SNSPF2 	=	75.0	;	%	(17) Wavelength (along-crest) of second set of plan-form sinuosities
