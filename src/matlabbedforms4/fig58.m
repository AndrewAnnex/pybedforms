FILENM 	=	'fig58'	;	%	
FIGCAP 	=	'Sinuous bedforms reversing with net migration' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SMPRDF 	=	12.0	;	%	(7)  Period of asymmetry cycle
...
SNSPS1 	=	36.0	;	%	(36) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGS1 	=	5.0 	;	%	(37) Amplitude (measured in plan-form) of first set of sinuosities
...
SNMGS2 	=	3.0 	;	%	(41) Amplitude (measured in plan-form) of second set of sinuosities
...
DEPCHG 	=	.08	;	%	(76) Amplitude of cycle in rate of deposition
