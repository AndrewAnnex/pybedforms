...
SNVLF2 	=	1.0 	;	%	(20) Migration speed (along-crest) of second set of sinuosities 
...
SNVLS1 	=	1.0 	;	%	(39) Migration speed (along-crest) of first set of sinuosities 
...
SNVLS2 	=	1.0 	;	%	(43) Migration speed (along-crest) of second set of sinuosities 
...
DEPRAT 	=	.12	;	%	(75) Rate of deposition
