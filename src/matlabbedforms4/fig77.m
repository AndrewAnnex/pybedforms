FILENM 	=	'fig77'	;	%	
FIGCAP 	=	'Reversing bedforms with migrating sinuosities' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
SMPRDF 	=	13.0	;	%	(7)  Period of asymmetry cycle
...
SNSPF1 	=	50.0	;	%	(13) Wavelength (along-crest) of first set of plan-form sinuosities
...
SNMGF2 	=	3.0 	;	%	(18) Amplitude (measured in plan-form) of second set of sinuosities
...
SNSPS1 	=	50.0	;	%	(36) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGS1 	=	6.0 	;	%	(37) Amplitude (measured in plan-form) of first set of sinuosities
