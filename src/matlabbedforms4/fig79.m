FILENM 	=	'fig79'	;	%	
FIGCAP 	=	'One set of bedforms replaced by smaller bedforms with a different trend' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
HTCHGF 	=	0.5	;	%	(10) Amplitude of steepness cycle
HTPRDF 	=	300.0	;	%	(11) Period of steepness cycle
HTFAZF 	=	180.0	;	%	(12) Phase of steepness cycle
...
VLCHGF 	=	1.0	;	%	(23) Amplitude of speed cycle
VLPRDF 	=	300.0	;	%	(24) Period of speed cycle
VLFAZF 	=	180.0	;	%	(25) Phase of speed cycle
SPCNGS 	=	20.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
...
HTCHGS 	=	0.5	;	%	(33) Amplitude of steepness cycle
HTPRDS 	=	300.0	;	%	(34) Period of steepness cycle
...
VLCHGS 	=	1.0	;	%	(46) Amplitude of speed cycle
VLPRDS 	=	300.0	;	%	(47) Period of speed cycle
...
NBEDSH 	=	1000	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD 	=	4	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	150	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
