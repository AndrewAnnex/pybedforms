FILENM 	=	'fig46m'	;	%	
FIGCAP 	=	'Two sets of bedforms height ratio is 0.3 speed ratio is 10.0' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
...
DEPRAT 	=	.016	;	%	(75) Rate of deposition
...
INTXBD 	=	15	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	100	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
