FILENM 	=	'fig45'	;	%	
FIGCAP 	=	'Oblique bedforms with pseudo-random shape and phase' 	;	%	  (2)  Caption (CHARACTER VARIABLE)
SPCNGF 	=	150.0	;	%	(3)  WAVELENGTH OF BEDFORMS IN FIRST SET
...
SNSPF1 	=	80.0	;	%	(13) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGF1 	=	9.0 	;	%	(14) Amplitude (measured in plan-form) of first set of sinuosities
SNFZF1 	=	0.0 	;	%	(15) Phase of first set of sinuosities
SNVLF1 	=	1.5 	;	%	(16) Migration speed (along-crest) of first set of sinuosities 
SNSPF2 	=	50.0	;	%	(17) Wavelength (along-crest) of second set of plan-form sinuosities
SNMGF2 	=	6.0 	;	%	(18) Amplitude (measured in plan-form) of second set of sinuosities
SNFZF2 	=	90.0 	;	%	(19) Phase of second set of sinuosities
SNVLF2 	=	1.5 	;	%	(20) Migration speed (along-crest) of second set of sinuosities 
...
SPCNGS 	=	150.0	;	%	(26) WAVELENGTH OF BEDFORMS IN SECOND SET
PHASES 	=	120.0	;	%	(27) Bedform phase (controls placement within block diagram)
...
SNSPS1 	=	70.0	;	%	(36) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGS1 	=	8.0 	;	%	(37) Amplitude (measured in plan-form) of first set of sinuosities
SNFZS1 	=	90.0 	;	%	(38) Phase of first set of sinuosities
SNVLS1 	=	1.5 	;	%	(39) Migration speed (along-crest) of first set of sinuosities 
SNSPS2 	=	40.0	;	%	(40) Wavelength (along-crest) of second set of plan-form sinuosities
SNMGS2 	=	4.0 	;	%	(41) Amplitude (measured in plan-form) of second set of sinuosities
SNFZS2 	=	70.0 	;	%	(42) Phase of second set of sinuosities
SNVLS2 	=	1.5 	;	%	(43) Migration speed (along-crest) of second set of sinuosities 
...
SPCNGT 	=	150.0	;	%	(49) WAVELENGTH OF BEDFORMS IN THIRD SET
PHASET 	=	240.0	;	%	(50) Bedform phase (controls placement within block diagram)
...
SNFZT1 	=	180.0 	;	%	(61) Phase of first set of sinuosities
SNVLT1 	=	1.5 	;	%	(62) Migration speed (along-crest) of first set of sinuosities 
SNSPT2 	=	30.0	;	%	(63) Wavelength (along-crest) of second set of plan-form sinuosities
SNMGT2 	=	3.0 	;	%	(64) Amplitude (measured in plan-form) of second set of sinuosities
SNFZT2 	=	0.0 	;	%	(65) Phase of second set of sinuosities
SNVLT2 	=	1.5 	;	%	(66) Migration speed (along-crest) of second set of sinuosities 
TRENDT 	=	0.0	;	%	(67) Migration direction of bedform
VELOCT 	=	1.0	;	%	(68) Mean migration speed of bedform
